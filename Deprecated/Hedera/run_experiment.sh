...
#         sudo python hedera.py -i $input_file -d $out_dir -p 0.03 -t $DURATION -n
# done
...
#         pref="fattree-ecmp"
#         out_dir=$OUTPUT_DIR/$pref/$f
#         sudo python hedera.py -i $input_file -d $out_dir -p 0.03 -t $DURATION --ecmp
# done
...
do
        ...
        pref="fattree-hedera"
        out_dir=$OUTPUT_DIR/$pref/$f
        sudo python hedera.py -i $input_file -d $out_dir -p 0.03 -t $DURATION --hedera
done
