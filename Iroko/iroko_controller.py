...
class ShortestForwarding(app_manager.RyuApp):
    ...
    #     if tcp_pkt:
    #         ip_proto = 6
    #         if tcp_pkt.src_port and tcp_pkt.src_port in bw_sensitive_port_list:
    #             L4_port = tcp_pkt.src_port
    #             Flag = 'src'
    #         elif tcp_pkt.dst_port and tcp_pkt.dst_port in bw_sensitive_port_list:
    ...
    #     elif udp_pkt:
    #         ip_proto = 17
    #         if udp_pkt.src_port and udp_pkt.src_port in bw_sensitive_port_list:
    #             L4_port = udp_pkt.src_port
    #             Flag = 'src'
    #         elif udp_pkt.dst_port and udp_pkt.dst_port in bw_sensitive_port_list:
