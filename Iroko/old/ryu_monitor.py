...
class SimpleMonitor13(app_manager.RyuApp):
    ...
    def _port_stats_reply_handler(self, ev):
        ...
        for stat in sorted(body, key=attrgetter('port_no')):
            self.logger.info('%8d %8x %10d %10d %10d %10d',
                             ev.msg.datapath.id, stat.port_no,
                             stat.rx_bytes, stat.rx_dropped,
                             stat.tx_bytes, stat.tx_dropped)
        # if _type == 'port':
        #     print('\ndatapath  port '
        ...
        #         self.traffic_matrix = {(ev.msg.datapath.id, stat.port_no): (stat.rx_dropped, stat.tx_dropped)}
        #     else:
        #         self.traffic_matrix[(ev.msg.datapath.id, stat.port_no)] = (stat.rx_dropped, stat.tx_dropped)
