...
class LearningAgentv3:
    def __init__(self, gamma=.99, lam=.1, s=2560, actions=16, memory=1000, initMax=0, defaultmax=10e6, cpath=None, apath=None, toExploit=False, frames=3, w=4):
        self.hosts = {}
        self.hostcount = 0
        self.gamma = gamma
        self.lam = lam
        ...
        self.controller = DDPGConv(gamma, memory, s, actions, tau=.001, criticpath=cpath, actorpath=apath, useSig=True, w=w, f=frames)
