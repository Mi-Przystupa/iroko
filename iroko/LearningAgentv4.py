...
class LearningAgentv4:
    def __init__(self, gamma=.99, lam=.1, s=320, actions=16, memory=1000, initMax=0, defaultmax=10e6, cpath=None, apath=None, toExploit=False):
        self.hosts = {}
        self.hostcount = 0
        self.gamma = gamma
        self.lam = lam
        ...
        self.controller = DDPG(gamma, memory, s, actions, tau=.001, criticpath=cpath, actorpath=apath, useSig=True)
