            ...
            for widget in self.widgetToItem:
                ...
                if 'Host' in tags:
                    ...
                    if 'cores' in opts or 'cpu' in opts:
                        f.write("    " + name + " = net.addHost('" + name + "', cls=CPULimitedHost, ip='" +
            ...
            if len(nflowValues['nflowTarget']) > 0:
                ...
                if nflowEnabled:
                    nflowCmd = 'ovs-vsctl -- --id=@MiniEditNF create NetFlow ' + 'target=\\\"' + \
                        nflowValues['nflowTarget'] + '\\\" ' + 'active-timeout=' + nflowValues['nflowTimeout']
            ...
            if len(sflowValues['sflowTarget']) > 0:
                ...
                if sflowEnabled:
                    sflowCmd = 'ovs-vsctl -- --id=@MiniEditSF create sFlow ' + 'target=\\\"' + \
                        ...
                        'sampling=' + sflowValues['sflowSampling'] + ' ' + 'polling=' + sflowValues['sflowPolling']
                    f.write("    \n")
